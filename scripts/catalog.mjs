...
const originalCatalog = [
  ...
  },
  {
    ...
    leftShort: '先立足，再权衡', rightShort: '成长优先', lenses: ['选择依据', '第一份工资的分量', '能不能兼得'],
    hosts: [
      '这里比较的是优先顺序，而不是把高薪和成长说成不能兼得。',
      '一边从微薄的第一份工资讲起，一边把毕业前三年的能力积累看得比薪资差额更重。',
      '两边都没有把收入和成长说成绝对对立，分歧在于取决于个人能力还是取决于个人类型。'
    ],
